			...
			<view :style="{color:color}" class="uni-navbar__header uni-navbar__content_view">
				<view class="uni-navbar__header-btns uni-navbar__content_view" @tap="onClickLeft">
					<view class="uni-navbar__content_view">
						...
						<image src="/static/back-d.png"  mode="" class="left-icon-back" v-if="leftIconType=='back-d'"></image>
						<image src="/static/back-l.png"  mode="" class="left-icon-back" v-if="leftIconType=='back-l'"></image>
						<image src="/static/tohome-l.png"  mode="" class="left-icon-home" v-if="leftIconType=='home-l'"></image>
						<image src="/static/tohome-d.png"  mode="" class="left-icon-home" v-if="leftIconType=='home-d'"></image>
					</view>
...
<script>
	import uniStatusBar from './statue-bar.vue'
