<template>
	...
	<view>
		<view class="modal_box" v-if="changeCarFlag" @click="closeModal"></view>
		<!-- 111111111111 首页的弹框 -->
		<view class="pick_box" :class="{show: changeCarFlag}">
			...
			<view class="pick_content" scroll-y="true" height="688upx;">
				...
				<view class="pick_item" v-for="(item, index) in carList" :key="index" @click="toObdDetail(item.id)">
					<image :src="carIcon+item.brand_id+'.png'" class="item_left_img"></image>
					<view class="car_msg">
